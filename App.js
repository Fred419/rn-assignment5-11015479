...
const transactionsData = [
  { title: 'Apple Store', image: appleLogo, category: 'Entertainment', amount: '-$6.99' },
  { title: 'Spotify', image: spotifyLogo, category: 'Music', amount: '-$10.99' },
  { title: 'Money Transfer', image: moneyTransferLogo, category: 'Finance', amount: '-$30.00' },
  { title: 'Grocery', image: groceryLogo, category: 'Shopping', amount: '-$46.00' },
];
      ...
      <View style={styles.header}>
        <View style={styles.profileContainer}>
          ...
          <View>
            ...
            <Text style={[styles.text, styles.boldText, isDarkMode && styles.darkText]}>Danso Fred</Text>
          </View>
        </View>
